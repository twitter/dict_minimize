...
def _unpack(
  x_vec: np.ndarray, from_np: Callable, shapes: OrderedDict, dtypes: OrderedDict
) -> OrderedDict:
...
def _minimize(
  ...
  *,
  ...
  """Minimization of a scalar function with a dictionary of variables as the input. It can interface
  to functions written outside of `numpy` (e.g., `tensorflow` or `torch`).
